...
public class TypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            int width = mediaExtractor.getVideoWidth();
            int height = mediaExtractor.getVideoHeight();

            dv = new DrawingView(this,(int)Math.ceil(mediaExtractor.getVideoFrameRate()*(mediaExtractor.getVideoDuration()/1000000f)),width,height);
